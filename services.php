...
<div class="services">
    ...
    <div class="serviceCard service-1">
        ...
        <h2>WordPress Design & Development</h2>
        ...
        <ul>
            ...
            <li>Audience, Issue, & Approach Analysis</li>
            <li>Customized Template Design</li>
            <li>Elementor Development</li>
            <li>WordPress CMS</li>
            <li>2 Editing Sessions</li>
            <li>1-3 Pages</li>
    ...
    <div class="serviceCard service-3">
        ...
        <ul>
            ...
            <li>Original Desings w/ Figma or XD</li>
            <li>Audience, Issue, & Approach Analysis</li>
            <li>Elementor Development</li>
            <li>WordPress CMS</li>
            <li>3 Editing Sessions</li>
            <li>3-5 Pages</li>
    ...
    <div class="serviceCard service-4">
        ...
        <ul>
            ...
            <li>Original Desings w/ Figma or XD</li>
            <li>Elementor Development</li>
            <li>WordPress CMS (recommended)</li>
            <li>MailChimp Service Integration (optional)</li>
            <li>3 Editing Sessions</li>
            <li>6-8 Pages</li>
            <li>3 Usability Tests</li>
    ...
    <div class="serviceCard service-5">
        ...
        <ul>
            ...
            <li>Audience, Issue, & Approach Analysis</li>
            <li>Original Desings w/ Figma or XD</li>
            <li>Elementor or PHP Development</li>
            <li>WordPress CMS (recommended)</li>
            <li>MailChimp Service Integration (optional)</li>
            <li>3 Editing Sessions</li>
            <li>Pages Negotiable</li>
            <li>Usability Testing</li>
            <li>15 Minute Updates Instrustional Video</li>
            <li>2 Edits After Project Completion (30 day experation)</li>
